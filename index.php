<?php
    ...
    {
        $recaptcha = json_decode(file_get_contents('https://www.google.com/recaptcha/api/siteverify?secret=6LdSpwgrAAAAAImqqDv-6HC3_HggMELc6n6CkHa8&response=' . $_POST['g-recaptcha-response']));
